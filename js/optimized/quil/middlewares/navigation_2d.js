...
return (function (p1__6652_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__6652_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_6653 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_6654 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_6653);
var pos_6655 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_6653);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_6654);

var tr__6556__auto___6656 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_6654) - cljs.core.first(pos_6655)),(((quil.core.height() / (2)) / zoom_6654) - cljs.core.second(pos_6655))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__6556__auto___6656);
...
var G__6657 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__6658 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__6657,G__6658) : user_mouse_dragged.call(null,G__6657,G__6658));
...
return (function (state,event){
var G__6659 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__6660 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__6659,G__6660) : user_mouse_wheel.call(null,G__6659,G__6660));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
